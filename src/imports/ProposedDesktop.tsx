...
import svgPaths from "./svg-4vihmbf681";
import imgImage1 from "figma:asset/b4e5d3f2ed235f5346cc914f60be90ae3980d9f5.png";
import imgImage2 from "figma:asset/6b0b767feb2e6d442310aec1f64e348954b32ed8.png";
import imgImage3 from "figma:asset/19387b8d642184bd3cfb9c473e4d7b8615f2d19a.png";
import imgImage4 from "figma:asset/3b5b71eb72e91ab4a4ebef5fcff3623759202027.png";
import imgImage5 from "figma:asset/ac986be69020249ee50e2508f158321c917ede1a.png";
import imgImage6 from "figma:asset/a979e4de3f5caa5fc393f579dd7d8a26a07bbeb7.png";
import imgImage7 from "figma:asset/c8a19f83070842cdb0114610dfc72dce10b3d2ec.png";
    ...
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full" data-name="Header">
      ...
      >
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 139.204 20">
          <path d={svgPaths.pbd2aa00} fill="var(--fill-0, #0056D2)" id="Union" />
        </svg>
      </a>
      <div className="h-0 relative shrink-0 w-full" data-name="Divider / Horizontal">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 604 1">
            <line id="Divider / Horizontal" stroke="var(--stroke-0, #DAE1ED)" x2="604" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f0f6ff] flex-[1_0_0] min-h-px min-w-px relative rounded-[16px]" data-name="Promo">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center px-[24px] py-[12px] relative w-full">
...
function Content() {
  return (
    <div className="content-stretch flex flex-col font-['Helvetica:Regular',sans-serif] gap-[16px] items-start relative shrink-0 text-[16px] w-full" data-name="_💠 Content">
...
function HeroCopy() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 text-[#0f1114] w-full" data-name="Hero copy">
      <p className="font-['Helvetica:Bold',sans-serif] leading-[40px] relative shrink-0 text-[32px] w-full">Develop AI fluency in 10 hours with Google experts</p>
      <Content />
    </div>
  );
}
...
function HeroContent() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="Hero content">
      <div className="aspect-[604/340] relative rounded-[16px] shrink-0 w-full" data-name="image 1">
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#0f1114] w-full">
      <p className="font-['Helvetica:Regular',sans-serif] leading-[18px] relative shrink-0 text-[12px] w-full">Google</p>
      <p className="font-['Helvetica:Bold',sans-serif] leading-[20px] relative shrink-0 text-[16px] w-full">Google AI Essentials</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[286px]">
      <div className="aspect-[286/161] relative rounded-[8px] shrink-0 w-full" data-name="image 2">
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#0f1114] w-full">
      <p className="font-['Helvetica:Regular',sans-serif] leading-[18px] relative shrink-0 text-[12px] w-full">Google</p>
      <p className="font-['Helvetica:Bold',sans-serif] leading-[20px] relative shrink-0 text-[16px] w-full">Google Prompting Essentials</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[286px]">
      <div className="aspect-[286/161] relative rounded-[8px] shrink-0 w-full" data-name="image 3">
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[286px]">
      <div className="aspect-[286/161] relative rounded-[8px] shrink-0 w-full" data-name="image 4">
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#0f1114] w-full">
      <p className="font-['Helvetica:Regular',sans-serif] leading-[18px] relative shrink-0 text-[12px] w-full">Google</p>
      <p className="font-['Helvetica:Bold',sans-serif] leading-[20px] relative shrink-0 text-[16px] w-full">Google Data Analytics</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[286px]">
      <div className="aspect-[286/161] relative rounded-[8px] shrink-0 w-full" data-name="image 5">
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#0f1114] w-full">
      <p className="font-['Helvetica:Regular',sans-serif] leading-[18px] relative shrink-0 text-[12px] w-full">Google</p>
      <p className="font-['Helvetica:Bold',sans-serif] leading-[20px] relative shrink-0 text-[16px] w-full">Google Project Management</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[286px]">
      <div className="aspect-[286/161] relative rounded-[8px] shrink-0 w-full" data-name="image 6">
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#0f1114] w-full">
      <p className="font-['Helvetica:Regular',sans-serif] leading-[18px] relative shrink-0 text-[12px] w-full">Google</p>
      <p className="font-['Helvetica:Bold',sans-serif] leading-[20px] relative shrink-0 text-[16px] w-full">Google Cybersecurity</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[286px]">
      <div className="aspect-[286/161] relative rounded-[8px] shrink-0 w-full" data-name="image 7">
...
function SectionContent() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="Section content">
      <SectionCopy />
      <SectionContent1 />
    </div>
  );
...
function HeroBanner() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-start relative shrink-0 w-full" data-name="Hero banner">
      <HeroContent />
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Desktop">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[48px] pt-[32px] px-[48px] relative w-full">
          <Frame1 />
        </div>
      </div>
    </div>
...
function FooterLinks() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-['Helvetica:Bold',sans-serif] font-bold gap-[12px] items-start leading-[22px] min-h-px min-w-[175px] not-italic relative text-[14px] text-white tracking-[0.005em] whitespace-nowrap" data-name="Footer links">
...
function Group7() {
  return (
    <div className="absolute inset-[21.09%_12.41%_63.01%_29.81%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 69.144 6.35832">
        <g id="Group">
...
function Footer() {
  return (
    <div className="bg-[#0f1114] relative shrink-0 w-full" data-name="Footer">
      <div className="content-stretch flex flex-col gap-[32px] items-start px-[48px] py-[32px] relative w-full">
        <Links />
        <LegalCopy />
      </div>
    </div>
...
export default function ProposedDesktop() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Proposed desktop">
      <Desktop />
      <Footer />
    </div>
  );
